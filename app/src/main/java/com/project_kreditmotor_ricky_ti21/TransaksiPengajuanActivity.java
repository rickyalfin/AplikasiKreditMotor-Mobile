...
public class TransaksiPengajuanActivity extends AppCompatActivity {
    ...
    public void simpanKredit() {
        ...
        String laporan = kredit.simpan_kredit(idkreditor,kdmotor,hrgtunai,dp,hrgkredit,bunga,lama,totalkredit,angsuran);Toast.makeText(TransaksiPengajuanActivity.this, laporan, Toast.LENGTH_SHORT).show();
